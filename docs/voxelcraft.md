...
New here? [`docs/voxelcraft-newcomer-guide.md`](docs/voxelcraft-newcomer-guide.md) is a longer walkthrough: what lives on which branch, how to run this locally, and how the reference data is organized.
