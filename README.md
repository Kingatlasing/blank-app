...
- **Archery Range** — a free practice activity (no ammo spent) available both at towns and on the open trail: hold the mouse down to draw a real bow sprite, release in the power meter's sweet spot to fire at a ring target, six arrows per round, cash payout based on score.
