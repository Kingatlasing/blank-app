...
- **Games** — five standalone casino-style games (Coin Flip, Roulette, Blackjack, Baccarat, Shell Game), each on its own no-scroll page, wagering the same simulated Cash balance as the pack store. Roulette covers outside bets only (red/black, odd/even, high/low); Blackjack and Baccarat follow standard casino rules (blackjack pays 3:2, baccarat banker bets carry a 5% commission, ties push on Player/Banker bets).
